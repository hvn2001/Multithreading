package InterviewPractice.ThreadSafeDeferredCallback.ReentrantLock2;
...
class DeferredCallbackExecutor {
    ...
    public static void runLateThenEarlyCallback() throws InterruptedException {
        ...
        // first submits a callback that should get executed after 8 seconds
        ...
        // 3 seconds later another call back is submitted
        Thread.sleep(3000);

        // which should be executed after only 1 second
