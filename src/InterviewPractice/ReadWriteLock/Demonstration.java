package InterviewPractice.ReadWriteLock;
...
class Demonstration {
    ...
    public static void main(String args[]) throws Exception {
        ...
        tReader2.join();
        t2.join();
        // A second writer thread is blocked forever
        // since the first writer thread never releases the write-lock. The execution eventually times out.
    }
}
